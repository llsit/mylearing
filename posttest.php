...
<body>
    ...
    <div class="ui main text container">
        <h1 class="ui header">Post-test วิชา : <?php echo "$name"; ?></h1>
        <br>
        <br>
                ...
                while ($result = $test->fetch_assoc()) {
                    ...
                    <div id='menu$i' class='tab-pane fade active in'>
                        ...
                        <div class='ui orange piled segment'>
                            ...
                            <div class='radio'>
                                <label><input type='radio' name='ans$i' value='$choice1'>A . $choice1</label>
                            </div>
                            <div class='radio'>
                                <label><input type='radio' name='ans$i' value='$choice2'>B . $choice2</label>
                            </div>
                            <div class='radio'>
                                <label><input type='radio' name='ans$i' value='$choice3'>C . $choice3</label>
                            </div>
                            <div class='radio'>
                                <label><input type='radio' name='ans$i' value='$choice4'>D . $choice4</label>
                            </div>
                        </div>
